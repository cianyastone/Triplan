        ...
        <Box _light={{ bg: white }} _dark={{ bg: darkBlack }} flex={1}>
            <ScrollView>
                ...
                <VStack alignItems="center" mb={20}>
                    ...
                    <FormControl mb={15} isRequired h={69} justifyContent="center" alignItems="center">
                        <Box mr={200} h={25} w={86} zIndex={1} alignItems="center"
                            _light={{ bg: white }} _dark={{ bg: darkBlack }}
                        >
                            <Text>Password</Text>
                        </Box>
                    ...
                    <Pressable alignItems="center">
                        ...
                        <Box position='absolute' h={55} w={320} 
                            ...
                            bg={orange}
                        />
                        <Heading position='absolute' mt={4} _light={{ color: white }} _dark={{ color: black }} fontSize="md">註冊</Heading>
                    </Pressable>
                    ...
                    <Pressable alignItems="center" onPress={() => goBack()}>
                        ...
                        <Box position='absolute' h={55} w={320} 
                            ...
                            bg={blue}
                        />
                        <Heading position='absolute' mt={4} _light={{ color: white }} _dark={{ color: black }} fontSize="md">點此登入</Heading>
                    </Pressable>
                </VStack>
            </ScrollView>
        </Box>
