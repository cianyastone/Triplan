...
import ActionButton from './ActionButton_light';
...
const UnfinishedTrip = ({ trip }) => {
    ...
    return (
        <Box w={150} h={200} mr={4} alignItems="center">
            ...
            >
                <Image position="absolute" mt={1} w={140} h={100} borderRadius={10} source={{uri: trip.image}}/>
                <Box position="absolute" mt={1} w={140} h={100} borderRadius={10} bg="rgba(29, 29, 29, 0.4)"/>
                <Box w="100%" alignItems="flex-end">
                    <ActionButton />
                </Box>
                <Flex direction="row" w="100%" justifyContent="flex-start" p={2} alignItems="flex-end">
                    <Box>
